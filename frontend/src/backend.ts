...
export class Backend implements backendInterface {
    ...
    async addPainting(arg0: PaintingId, arg1: string, arg2: string, arg3: Price, arg4: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPainting(arg0, arg1, arg2, arg3, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deletePainting(arg0: PaintingId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllPaintings(): Promise<Array<Painting>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPaintings();
    ...
    async getPainting(arg0: PaintingId): Promise<Painting | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPainting(arg0);
    ...
    async togglePaintingSoldStatus(arg0: PaintingId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.togglePaintingSoldStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePainting(arg0: PaintingId, arg1: string, arg2: string, arg3: Price, arg4: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePainting(arg0, arg1, arg2, arg3, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Painting_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Painting): Promise<Painting> {
...
async function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Painting]): Promise<Painting | null> {
    return value.length === 0 ? null : await from_candid_Painting_n13(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Painting>): Promise<Array<Painting>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Painting_n13(_uploadFile, _downloadFile, x)));
}
